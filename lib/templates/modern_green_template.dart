            ...
            pw.Partitions(
              children: [
                ...
                pw.Partition(
                  width: 190,
                  child: pw.Padding(
                    padding: const pw.EdgeInsets.only(left: 20, right: 20, top: 25),
                    child: pw.Column(
                      ...
                      children: [
                        ...
                        // Skills Section - Immediately following
        ...
        widgets.add(
          pw.Padding(
            ...
            child: pw.Row(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('•', style: pw.TextStyle(font: font, fontSize: 11, color: PdfColor.fromHex('#374151'))),
                pw.SizedBox(width: 6),
                pw.Expanded(
                  child: pw.Text(
                    trimmedLine
        ...
        children: [
          pw.Expanded(
            child: pw.Padding(
              padding: const pw.EdgeInsets.only(right: 20),
              child: pw.Text(
                (edu.description != null && edu.description!.isNotEmpty ? edu.description! : edu.degree).trim(),
                style: pw.TextStyle(
                    font: fontBold, fontSize: 12, color: PdfColors.black),
              ),
            ),
